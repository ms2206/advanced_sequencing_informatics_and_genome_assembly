...
###
# USAGE: ./my_split_and_run_sparc.sh [BACKBONE_FASTA] [CONSENSUS_FASTA] [READS_FASTA] [OUTPUT_DIR] [ITERATIONS] ###
...
/DBG2OLC/utility/split_reads_by_backbone.py -b ${backbone_fasta} -o ${split_dir} -r ${reads_fasta} -c ${consensus_fasta} 
...
for file in $(ls ${split_dir}/*.reads.fasta); do
    ...
    for iter in `seq 1 ${iterations}`; do
        ...
        cmd+="/DBG2OLC/compiled/Sparc m ${split_dir}/${chunk}.mapped.m5 b ${split_dir}/${chunk}.fasta k 1 c 2 g 1 HQ_Prefix Contig boost 5 t 0.2 o ${split_dir}/${chunk}; "

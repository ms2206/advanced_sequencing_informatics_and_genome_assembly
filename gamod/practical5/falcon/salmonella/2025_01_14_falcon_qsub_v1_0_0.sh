...
#PBS -N 2025_01_14_falcon_qsub_v1_0_0
...
input_file="${working_folder}/data/salmonella/SRR8066536_15perc.fastq.gz"
falcon_dir="${working_folder}/practical5/falcon/salmonella/"
fasta_name="SRR8066536_15perc.fasta"
    
# FALCON manipulation
zcat ${input_file} | \
    awk '{if(NR %4 <3){if(NR % 4 == 1){split($3,a,"length="); 
    print ">"substr($1,2,length($1))"/"NR"/0_"a[2]}
    else {if(NR % 4 == 2){print}}}}' >\
   ${falcon_dir}/${fasta_name}
